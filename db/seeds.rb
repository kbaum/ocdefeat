...
Theme.create(name: "Existentialism", definition: "This theme is characterized by preoccupation with philosophical questions about the meaning of life.", user_id: 2)
Theme.create(name: "Perfectionism", definition: "This theme is characterized by preoccupation with making mistakes and the need to exert absolute control.", user_id: 3)
Theme.create(name: "Contamination", definition: "This theme is characterized by the fear of being exposed to contaminants, including germs, illnesses and toxic substances.", user_id: 2)
Theme.create(name: "Scrupulosity", definition: "This theme is characterized by preoccupation with religious and moral values.", user_id: 3)
Theme.create(name: "Sensorimotor OCD", definition: "This theme is characterized by hyperfixation on automatic bodily processes such as swallowing, breathing or blinking.", user_id: 2)
Theme.create(name: "Symmetry and Orderliness", definition: "This theme is characterized by the urge to arrange one's environment in a precise and rigid way.", user_id: 3)
